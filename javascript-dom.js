...
const calculatePaymentsButton = document.getElementById(
...
function showPaymentResults(array) {
  ...
  newHeaderElement.innerText =
    groupNameInput + " - Thank you for using this tool.";
  ...
  for (let i = 0; i <= array.length - 1; i++) {
    ...
    const listElementn =
      orderedListPaymentsElement.getElementsByTagName("tr")[i];
